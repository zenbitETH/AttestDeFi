...
export default function Navbar({ step }: { step: number }) {
  return (
    <motion.nav
      ...
      initial="initial"
      animate="animate"
      className="flex w-full pt-5 h-[170px]  space-x-[17px] text-[16px] justify-center md:flex-col md:space-x-0 md:space-y-8  md:h-[720px] md:w-[290px] md:justify-start md:rounded-xl text-white"
    >
